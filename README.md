...
```bash
git clone https://github.com/jeevan7173/MovieIQ-Predictive-Analytics-on-Film-Success.git
...
## 📄 License
This project is open source and available under the [SJCE License.](https://sjce-license.org/) 
